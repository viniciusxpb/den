    ...
    fn new() -> Self {
        ...
        let files = find_scss_files(&pages_dir)
            ...
            .filter_map(|path| {
                ...
                let classes = parse_scss_for_editing(&raw);
...
fn render_property(ui: &mut egui::Ui, prop: &mut EditableProperty) -> bool {
...
fn find_scss_files(dir: &std::path::Path) -> Vec<PathBuf> {
...
fn write_back(file: &mut ScssFile) {
...
fn parse_scss_for_editing(content: &str) -> Vec<EditableClass> {
